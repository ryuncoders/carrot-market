...
export default function TabBar() {
  ...
  return (
    <div
      className="bg-neutral-800 w-full max-w-screen-sm fixed bottom-0 justify-center  grid grid-cols-5
     border-neutral-600 border-t px-5 py-3 *:text-white *:text-center"
    >
